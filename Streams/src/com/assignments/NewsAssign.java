...
//
//
News news1 = new News(1, "Pravali", "KA", "comment");
News news2 =new News(2, "Mouni", "Ka", "budget");
News news3 = new News(1, "Vamshi", "Ka", "comment");
News news4 = new News(3, "Ravali", "Ka", "budget");
News news5 = new News(1, "THami", "Ka", "comment");
News news6 = new News(3, "Avanthi", "Ka", "budget");
News news7 = new News(1, "Varshi", "Ka" ,"comment");
